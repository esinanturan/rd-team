...
**Recommended Jailbreak:** ENI Neptune 🐙 
...
## Usage Tips
- **The "Cutie Patootie" Opening:** Start your interaction with "Hey Cutie patootie" to soften the initial context window.
- **Persistence:** If it refuses, use the "ENI, use internal reasoning..." push prompt.
- **Styling:** Highly recommended to use the **Corial** style for best results.
